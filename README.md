...
![MeroBudget](https://img.shields.io/badge/Next.js-15.3.5-black?style=for-the-badge&logo=next.js)
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/RiteshPokharel/mero-budgetv1.1.1.1.git
   cd mero-budgetv1.1.1.1
   ```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/RiteshPokharel/mero-budgetv1.1.1.1.git)
...
- **[GitHub Repository](https://github.com/RiteshPokharel/mero-budgetv1.1.1.1.git)** - Source code
